...
<link href="<?php echo ($config_siteurl); ?>statics/css/admin_layout.css?v=" rel="stylesheet" />
...
<div class="wrap">
  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      <th><a href="<?php echo U('Index/index');?>" class="logo">管理中心</a></th>
      <td><div class="nav"> 
          <!-- 菜单异步获取，采用json格式，由js处理菜单展示结构 -->
          <ul id="J_B_main_block">
          </ul>
        </div>
        <div class="login_info"><span class="mr10"><?php echo ($role_name); ?>： <?php echo ($userInfo["username"]); ?></span><a href="<?php echo U('Public/logout');?>" class="mr10">[注销]</a><?php echo tag("view_admin_top_menu");?><a href="<?php echo ($Config["siteurl"]); ?>" class="home" target="_blank">前台首页</a><?php if(\Libs\System\RBAC::authenticate('Admin/Index/cache')){ ?><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a><?php } ?></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
          <input size="15" placeholder="Hi，ShuipFCMS！" id="J_search_keyword" type="text">
          <button type="button" name="keyword" id="J_search" value="" data-url="<?php echo ($config_siteurl); ?>index.php?g=Admin&m=Index&a=public_find">搜索</button>
        </div></th>
    ...
    <tr class="content">
      ...
      <td id="B_frame" style="height:100%;">
        ...
        <iframe id="iframe_default" src="<?php echo U('Main/index');?>" style="height: 100%; width: 100%;display:none;" data-id="default" frameborder="0" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
