...
.header h1{ background-image:url(<?php echo ($config_siteurl); ?>statics/images/logo.gif);background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
...
.qzone_cont .scroll_img li{ width:10px;height:10px;background-image:url(<?php echo ($config_siteurl); ?>statics/images/qzone_login.png);background-position:-663px 0;background-repeat:no-repeat;display:inline-block;margin-right:15px;cursor:pointer;*display:inline;*zoom:1;overflow:hidden}
.qzone_cont .scroll_img .current_img{ background-image:url(<?php echo ($config_siteurl); ?>statics/images/admin_img/qzone_login.png);background-position:-663px -17px}
...
.login_main .login_btn{ width:148px;height:48px;line-height:150px;overflow:hidden;font-size:0;*background:none;background-image:url(<?php echo ($config_siteurl); ?>statics/images/qzone_login.png);background-position:-514px 0;border:none;cursor:pointer}
...
.platform_box nav{ background-image:url(<?php echo ($config_siteurl); ?>statics/images/qzone_login.png);background-position:0 0;background-repeat:no-repeat;width:370px;height:52px;margin:0 auto}
...
.footer{ background:#f0f0f0 url(<?php echo ($config_siteurl); ?>statics/images/ft_bg.jpg) repeat-x;color:#999}
  ...
  <div class="inner">
    ...
    <div class="qzone_login clearfix">
      <div class="qzone_cont" id="_pt">
        <li><img src="<?php echo ($config_siteurl); ?>statics/images/login_bg.jpg" alt="生活以快乐为基准，爱情以互惠为原则！"></li>
      </div>
      <!-- end qzone_cont -->
      <div class="login_main">
        <p class="wrong_notice" id="err_m" style="display:none;"></p>
        <form id="loginform" method="post" name="loginform" action="<?php echo U('Public/tologin');?>"   >
          <ul class="login_list"  id="web_login">
            ...
            <li class="yanzhengma clearfix" id="verifytip"> <span id="verifyinput">
              ...
              <div class="yanzhengma_box" id="verifyshow"> <img class="yanzheng_img" id="code_img" alt="" src="<?php echo U('Api/Checkcode/index','code_len=4&font_size=20&width=130&height=50&font_color=&background=');?>"><a href="javascript:;;" onClick="refreshs()" class="change_img">看不清，换一张</a> </div>
            </li>
            <li>
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2012 - <?php echo date('Y');?> , ShuipfCMS All Rights Reserved.</p>
